...
function OrderSummary() {
  ...
  <div class="flex text-center space-y-2 flex-col">
    <h1 class="text-3xl dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">تم تاكيد الطلبية</h1>
    <p class="text-base dark:text-gray-300 font-medium leading-6 text-gray-600">21st mars 2023 at 10:34 PM</p>
          ...
          <div class="flex justify-between items-start w-full">
            <div class="flex justify-center items-center space-x-4">
              ...
              <div class="flex flex-col justify-start items-center">
                <p class="text-lg leading-6 dark:text-white font-semibold text-gray-800"><span class="font-normal">سيتم الاتصال بك من طرف البائع لتاكيدطلبيتك و لمناقشة  المزيد من التفاصيل</span></p>
              </div>
            </div>
          </div>
